...
struct SettingsPanelView: View {
  ...
  private var resolvedFlipFormat: FlipClockFormat {
    FlipClockFormat.resolved(fromRaw: flipClockFormatRaw)
  }
  ...
  /// 翻页版式紧跟时间精度，仅「秒」精度下可选三等分
  @ViewBuilder
  private var flipFormatLinkedBlock: some View {
